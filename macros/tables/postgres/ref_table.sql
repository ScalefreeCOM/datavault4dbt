{%- macro postgres__ref_table(ref_hub, ref_satellites, src_ldts, src_rsrc, historized, snapshot_trigger_column='is_active', snapshot_relation=none, include_business_objects_before_appearance=false) -%}
