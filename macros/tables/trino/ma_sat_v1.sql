{%- macro trino__ma_sat_v1(sat_v0, hashkey, hashdiff, ma_attribute, src_ldts, src_rsrc, ledts_alias, add_is_current_flag) -%}
...
end_dated_source AS (
    ...
    SELECT
        ...
        {%- if add_is_current_flag %}
            CASE WHEN edl.{{ ledts_alias }} = {{ datavault4dbt.string_to_timestamp(timestamp_format, end_of_all_times) }}
            THEN TRUE
            ELSE FALSE
