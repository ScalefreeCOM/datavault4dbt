...
unknown_values AS (
    ...
    {{ datavault4dbt.string_to_timestamp( timestamp_format , beginning_of_all_times) }} as LDTS, 
    'SYSTEM' as RSRC,
...
error_values AS (
    ...
    {{ datavault4dbt.string_to_timestamp( timestamp_format , end_of_all_times) }} as LDTS,
    'ERROR' as RSRC,
