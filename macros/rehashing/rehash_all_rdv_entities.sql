{#
    This macro can rehash your entire RDV. It will process a single yml file/value and rehash every entity thats defined in it. 
    ...
    How to use: 
        ...
        Therefor we recommend calling this macro in a new model, which allows to easily define a longer yaml. 
        ...
        After saving this model, just execute it with a simple 'dbt run -s rehash_model' against your desired target. 
