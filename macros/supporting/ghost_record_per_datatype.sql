...
{%- if ghost_record_type == 'unknown' -%}
        ...
        {%- elif 'CHAR' in datatype -%}
            ...
            {%- else -%}
                CAST('{{ unknown_value__STRING }}' as {{ datatype }} ) as "{{ alias }}"
            {%- endif -%}
        {%- elif 'INT' in datatype or datatype == 'DECIMAL' or datatype == 'NUMERIC' or 'MONEY' in datatype or datatype == 'BIT'%} CAST('0' as {{ datatype }}) as "{{ alias }}"
...
{%- elif ghost_record_type == 'error' -%}
        ...
        {%- elif 'CHAR' in datatype -%}
            ...
            {%- else -%}
                CAST('{{ error_value__STRING }}' as {{ datatype }} ) as "{{ alias }}"
            {%- endif -%}
        {%- elif 'INT' in datatype or datatype == 'DECIMAL' or datatype == 'NUMERIC' or 'MONEY' in datatype %} CAST('-1' as {{ datatype }}) as "{{ alias }}"
