...
ELSE CONCAT('"', REPLACE(REPLACE(REPLACE(TRIM(CAST([EXPRESSION] AS VARCHAR(20000) UTF8 )), '\\\', '\\\\\'), '[QUOTE]', '"'), '[NULL_PLACEHOLDER_STRING]', '--'), '"') END
...
'"' + REPLACE(REPLACE(REPLACE(LTRIM(RTRIM([EXPRESSION])), '\\', '\\\\'), '[QUOTE]', '\"'), '[NULL_PLACEHOLDER_STRING]', '--') + '"'
...
{%- if 'VARBINARY' in datatype %}
    ...
    {%- if case_sensitive -%}
        {%- set standardise_prefix = "ISNULL(HASHBYTES('{}', (STRING_AGG({}NULLIF(CAST(REPLACE(REPLACE(REPLACE(REPLACE(CONCAT(".format(hash_alg, hdiff_prefix)-%}
        {%- if alias is not none -%}
    ...
    {%- else -%}
        ...
        {%- set standardise_prefix = "ISNULL(HASHBYTES('{}', (STRING_AGG({}NULLIF(CAST(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(CONCAT(".format(hash_alg, hdiff_prefix)-%}
...
{%- else -%}
    ...
    {%- if case_sensitive -%}     
        ...
        {%- set standardise_prefix = "LOWER(ISNULL(CONVERT({}, HASHBYTES('{}', (STRING_AGG({}NULLIF(CAST(REPLACE(REPLACE(REPLACE(REPLACE(CONCAT(".format(datatype, hash_alg, hdiff_prefix)-%}
    ...
    {%- else -%}
        ...
        {%- set standardise_prefix = "LOWER(ISNULL(CONVERT({}, HASHBYTES('{}', (STRING_AGG({}NULLIF(CAST(REPLACE(REPLACE(REPLACE(REPLACE(UPPER(CONCAT(".format(datatype, hash_alg, hdiff_prefix)-%}
...
{%- if datatype == 'STRING' -%}
    ...
    {%- if not case_sensitive -%}
        ...
        {%- if alias is not none -%}
            {%- set standardise_suffix = "\n)), r'\\n', '') \n, r'\\t', '') \n, r'\\v', '') \n, r'\\r', '') AS STRING), '[ALL_NULL]'{}))),(left, right) -> ".format(hdiff_suffix)~datavault4dbt.generate_comparator(multi_active_key)~"))), {}) AS {}".format(zero_key, alias)-%}
        {%- else -%}
            {%- set standardise_suffix = "\n)), r'\\n', '') \n, r'\\t', '') \n, r'\\v', '') \n, r'\\r', '') AS STRING), '[ALL_NULL]'{}))),(left, right) -> ".format(hdiff_suffix)~datavault4dbt.generate_comparator(multi_active_key)~"))), {})".format(zero_key)-%}
        {%- endif -%}
    {%- else -%}
...
{%- else -%}
    ...
    {%- if not case_sensitive -%}
        ...
        {%- if alias is not none -%}
            {%- set standardise_suffix = "\n)), r'\\n', '') \n, r'\\t', '') \n, r'\\v', '') \n, r'\\r', '') AS STRING), '[ALL_NULL]'{}))),(left, right) -> ".format(hdiff_suffix)~generate_comparator(multi_active_key)~")) AS {}), CAST({} AS {})) AS {}".format(datatype, zero_key, datatype, alias)-%}
        {%- else -%}
            {%- set standardise_suffix = "\n)), r'\\n', '') \n, r'\\t', '') \n, r'\\v', '') \n, r'\\r', '') AS STRING), '[ALL_NULL]'{}))),(left, right) -> ".format(hdiff_suffix)~generate_comparator(multi_active_key)~")) AS {}), CAST({} AS {}))".format(datatype, zero_key, datatype)-%}
        {%- endif -%}
    {%- else -%}
