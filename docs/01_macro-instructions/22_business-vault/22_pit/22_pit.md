...
With this example, a PIT Table is created. In line three of this example, the post hook “clean_up_pit” is used. For further information about the hook, click on the following link: [Hook Clean Up PITs](./23_hook-cleanup-pits.md)
